          ...
          <ButtonGroup variant="text" className="portfolio-title">
            <Button component={Link} to="/About">
              <Avatar
                ...
                size="small"
                variant="rounded"
                src={`${utilities.imageFolder}logo-10.png`}
              />
            </Button>
          ...
          <Hidden xsDown>
            ...
            >
              ...
              <Button
                component={Link}
                to="/Portfolio"
                className={getLinkClass(location.pathname, "/Portfolio")}
              >
                Portfolio
              </Button>
              <Button
                component={Link}
                to="/Contact"
                className={getLinkClass(location.pathname, "/Contact")}
              >
                Contact
              </Button>
            </ButtonGroup>
...
function getLinkClass(currentPath, route) {
  if (route === "/") {
    ...
    return currentPath !== "/Portfolio" && currentPath !== "/Contact"
      ? "active"
      : "";
  }
